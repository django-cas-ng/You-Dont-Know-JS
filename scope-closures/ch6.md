...
# Chapter 6: Block Scope

| NOTE: |
| :--- |
| Work in progress |

So far our focus has been on explaining how scopes and variables work. With that foundation firmly in place, our attention now expands to a higher level of thinking: the patterns and decisions we make across the whole program.

First, we're going to look at how and why we should be using the scope of blocks to organize our program's variables.
