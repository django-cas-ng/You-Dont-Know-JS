...
The global scope of a JS program is a rich topic, with much more utility and nuance than you would likely assume. This chapter starts by exploring whether the global scope is (still) useful and relevant to writing JS programs, and then we'll look at differences in how the global scope is *found* in different JS environments.
